package com.taisau.repository.util;
...
public class CameraUtils2 {
    ...
    private static FAIL_STATUS status = FAIL_STATUS.NOT_FIND_CAMERA;
    private boolean support720 = false;
    private boolean support1080 = false;
